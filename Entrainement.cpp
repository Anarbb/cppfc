...
Entrainement::Entrainement(const std::string &jour, const std::string &heure, const Sport &sport, const SalleEntrainement &salle)
...
size_t Entrainement::getIndex() const {
    return index;
}

void Entrainement::setIndex(size_t index) {
    this->index = index;
}
